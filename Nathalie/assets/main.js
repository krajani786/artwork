...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('#text01', { style: 'fade-right', speed: 1000, intensity: 0, delay: 0, staggerOrder: '', state: true, replay: false });
		onvisible.add('#text03', { style: 'fade-right', speed: 1000, intensity: 0, delay: 0, staggerOrder: '', state: true, replay: false });
		onvisible.add('#text02', { style: 'fade-right', speed: 1000, intensity: 0, delay: 0, staggerOrder: '', state: true, replay: false });
		onvisible.add('#icons01', { style: 'fade-in', speed: 1000, intensity: 0, delay: 250, stagger: 125, staggerOrder: 'reverse', state: true, replay: false });
		onvisible.add('#container01 > .wrapper > .inner', { style: 'fade-down', speed: 1000, intensity: 5, delay: 0, state: true, replay: false });
